...
class Stats:
    def __init__(self, user):
        ...
        self.graph1 = PhotoImage(file = "Parametters/graph1.png")
        self.graph2 = PhotoImage(file = "Parametters/graph2.png")
        self.graph3 = PhotoImage(file = "Parametters/graph3.png")
        self.graph4 = PhotoImage(file = "Parametters/graph4.png")
        self.graph5 = PhotoImage(file = "Parametters/graph5.png")
        ...
        1, 0, 0, 4, 5, 1, 0, 0, 4, 5,  #Parties
        1, 0, 0, 4, 5, 1, 0, 0, 4, 5,  #Score max
            ...
            if sur_qui == "Statistiques globales": #si la personne veut un graphique sur les gens
                for value in self.data[1][lequel].values():
                    for pos in value.keys():
                        try:x0[pos] += value[pos]
                        except:x0[pos] = value[pos]
        ...
        if sur_quoi == "Statistiques sur jeu": #si la personne veut un graphique sur les Jeux
            ...
            if sur_qui == "Statistiques globales": #si la personne veut un graphique sur les gens
                ...
                if lequel == "Parties": #Nombres de parties du joueur en fonction de jeu*
                    ...
                    for games in self.data[0].keys():
                        y.append(games)
                        try: x0.append(self.data[0][games]["player_count"][self.user][0])
                        except: x0.append(0)
                elif lequel == "Score max": #Meilleur score du joueur en fonction du jeu
                    title = "Score maximum en \n fonction des jeux"
                    Legend1 = "Score max"
        ...
        if sur_quoi == "Statistiques sur jeu": #si la personne veut un graphique sur les Jeux
            ...
            if sur_qui == "Statistiques globales": #si la personne veut un graphique sur les gens
                if lequel == "Parties": #Nombres de parties du joueur en fonction de jeu*
                    ...
                    x0 ={"Temps moyen passé par {}".format(self.user): {},"Temps passé en moyenne": {}, "Temps passé en moyenne par le meilleur":{}}
                    for parametters in x0:
                        for games in self.data[2].keys():
                            if parametters == "Temps moyen passé par {}".format(self.user):
                                try: x0[parametters][games] = self.data[2][games]["player_count"][self.user]
                                except: x0[parametters][games] = 0
                            elif parametters == "Temps passé en moyenne":
                                try: x0[parametters][games] = self.data[2][games]["moyenne"]
                                except: x0[parametters][games] = 0
                            elif parametters == "Temps passé en moyenne par le meilleur":
                                try: x0[parametters][games] = self.data[2][games]['player_count'][get_game_score_list(games)[0][0]]
                                except: x0[parametters][games] = 0
                ...
                if lequel == "Parties": #Nombres de parties du joueur en fonction de jeu*
                    ...
                    for games in x0:
                        ...
                        try: x0[games]["Nb de parties du meilleur joueur"] = self.data[0][games]["player_count"][get_game_score_list(games)[0][0]][0]
                        except: x0[games]["Nb de parties du meilleur joueur "] = 0
                        try: x0[games]["Nb parties de {}".format(self.user)] = self.data[0][games]["player_count"][self.user][0]
                        except: x0[games]["Nb parties de {}".format(self.user)] = 0
                elif lequel == "Score max": #Meilleur score du joueur en fonction du jeu
                    label_y = "Différents Scores"
                    label_x = "Jeux"
                    title = "Différentes stats sur les Scores Max en fonction des Jeux"
                    ...
                    x0 ={'Tete': {}, 'Pendu': {}, 'Ghost': {},'Snake': {},'Minesweeper': {}, 'Tetris': {}, 'Pong': {},  'Flappy': {}}
                    for games in x0:
                        try: x0[games]["Temps moyen passé par {}".format(self.user)] = self.data[2][games]["player_count"][self.user]
                        ...
                        try: x0[games]["Temps passé en moyenne par le meilleur"] = self.data[2][games]['player_count'][get_game_score_list(games)[0][0]]
                        except: x0[games]["Temps passé en moyenne par le meilleur"] = 0
